...
favicon_path = os.path.dirname(jasmine_core.Core.favicon())
jasmine_path = os.path.dirname(jasmine_core.__file__)
...
urlpatterns = patterns(
    ...
    url(r'^__boot__/(?P<path>.*)$', 'django.views.static.serve', {'document_root': jasmine_path, }, name='jasmine_boot'),
    url(r'^__jasmine__/(?P<path>.*)$', 'django.views.static.serve', {'document_root': jasmine_path, }, name='jasmine_core'),
